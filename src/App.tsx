...
import Products from "./components/ProductCard/ProductCard.tsx";
            ...
            <div>
              <Routes>
                <Route path="/" element={<Layout/>}>
                  ...
                  <Route path={"/deprecatedSidebar"} element={<LeftSidebar/>}/>
                  <Route path="/filters" element={<ProductFilters onFilterChange={() => {
                  }}/>}/>
                </ Route>
              </Routes>
